...
app.get('/qr', (_, res) => {
  if (isReady) return res.send(`<!DOCTYPE html><html><link rel="icon" href="https://businessasesores.web.app/wp-content/uploads/2022/03/wp-icon-1.png" sizes="32x32">
    <link rel="icon" href="https://businessasesores.web.app/wp-content/uploads/2022/03/wp-icon-1.png" sizes="192x192"><body style="font-family:sans-serif;text-align:center;padding:60px;background:#0a0a0f;color:#fff">
  ...
  if (!qrB64) return res.send(`<!DOCTYPE html><html><link rel="icon" href="https://businessasesores.web.app/wp-content/uploads/2022/03/wp-icon-1.png" sizes="32x32">
    <link rel="icon" href="https://businessasesores.web.app/wp-content/uploads/2022/03/wp-icon-1.png" sizes="192x192"><body style="font-family:sans-serif;text-align:center;padding:60px;background:#0a0a0f;color:#fff">
